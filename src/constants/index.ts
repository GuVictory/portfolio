...
const experiences = [
    {
        ...
        points: [
            'Cовместно с разработкой занимаюсь оптимизацией кодовой базой мобильного приложения и бека, помогла ускорить время загрузки приложения при слабом интернете более чем на 20%',
            'Описываю и поддерживаю в актуальном состоянии документацию и контакты взаимодействия',
